...
function sendOTP() {
    ...
    fetch("https://qrcodelogin-main-5j9v.onrender.com/send-otp", {
        method: "POST",
...
function verifyOTP() {
    ...
    fetch("https://qrcodelogin-main-5j9v.onrender.com/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
function loadUserScans(phone) {
    fetch("https://qrcodelogin-main-5j9v.onrender.com/get-user-scans", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ phone })
    })
